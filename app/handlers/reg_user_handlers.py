...
@register_router.callback_query(F.data == 'start_test')
async def register(callback: CallbackQuery, state: FSMContext):
    await state.set_state(UserData.waiting_for_name)
    await callback.message.answer('Введите ваше имя:')

@register_router.message(UserData.waiting_for_name)
...
@register_router.message(UserData.waiting_for_age)
...
@register_router.message(UserData.waiting_for_email)
...
@register_router.message(UserData.waiting_for_phone)
async def register_email(message: Message, state: FSMContext):
    phone = message.text
...
@register_router.message(UserData.waiting_for_child_count)
