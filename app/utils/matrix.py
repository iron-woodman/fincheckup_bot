...
#         self.questions = []  # Список вопросов
#         self.df = None  # DataFrame для данных из Excel
#         self.excel_file = r'..\..\quiz_data\quiz_matrix.xlsx'
#         # Проверка существования файла
#         if not os.path.exists(self.excel_file):
#             raise FileNotFoundError(f"Файл не найден: {self.excel_file}")
#         self.process_matrix_file(self.excel_file)
#         self.extract_questions()
#
#     def process_matrix_file(self, excel_file):
#         """Загрузка данных из Excel файла."""
#         self.df = pd.read_excel(excel_file, header=1)
#         self.df.columns = self.df.columns.str.strip()
#         self.df['Ответы / критерии (вес) / баллы'] = self.df['Ответы / критерии (вес) / баллы'].str.strip()
#
